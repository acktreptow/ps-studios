...
function VisualArtsPage(): JSX.Element {
  return (
    <Container>
      ...
      <Paragraph>
        Founded in San Diego in 2007, the Visual Arts Service Group support
        games from other PS Studios with art and animation. As a support studio,
        their contributions are small, but it means VASG work on 15-25 games at
        a time, in addition to Sony&#39;s non-gaming IP like Netflix&#39;s Love,
        Death & Robots. While it&#39;s not the traditional role of a developer,
        there was a failed pivot to become one in 2018.
      </Paragraph>
      <Paragraph>
        ...
        game, it was too hard to modernize for PS5 at that size. VASG then
        settled on 2013&#39;s The Last of Us - a more modern PS3 game.
        Afterwards, VASG could hire up for Uncharted, then their own titles.
      </Paragraph>
      <Paragraph>
        The TLOU remake (Project T1X) was probationally approved, meaning it
        stayed a secret with no budget to hire up. VASG questioned Sony&#39;s
        ...
        As part of his new role, Hulst thoroughly reviewed the entire PS Studios
        portfolio and grew concerned with T1X&#39;s budget. Mumbauer argued this
        was VASG&#39;s first project, on a new engine, and they had to hire up
        to modernize gameplay. Hulst was unconvinced.
      </Paragraph>
      <Paragraph marginBottom={8}>
        Instead, VASG supported Naughty Dog&#39;s TLOU2 after its delay to 2020.
        Once shipped, instead of hiring up, T1X shifted to ND&#39;s budget and
        ND joined in a support role. Mumbauer knew this would strip autonomy as
        ND outpaced VASG&#39;s work due to their size. ND also had Sony&#39;s
        trust as the IP&#39;s original developer, effectively giving them final
        say. VASG were now jokingly referred to as ND South, so in late 2020,
        with his vision dead, Mumbauer and many others quit. VASG now continue
        in the support role Sony always saw them in.
      </Paragraph>
