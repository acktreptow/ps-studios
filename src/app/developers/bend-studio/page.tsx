    ...
    <Container>
      ...
      <ImageSection flexOnMdScreens={false}>
        <div>
          ...
          <Paragraph>
            Despite DG shipping over 6 years ago, we don&#39;t even have a name
            for Bend&#39;s next game due to a very long string of bad luck and
            incompetence:
          </Paragraph>
          <List>
            <li>
              Bend pitched Days Gone 2, which Sony rejected due to DG&#39;s
              initial reception.
            </li>
            <li>
          ...
          <Paragraph>
            ...
            consensus around the IP in 2026, there&#39;s a better chance DG2 is
            greenlit than in recent years, which is the best-case scenario.
          </Paragraph>
          <Paragraph marginBottom={8}>
            The worst-case scenario is Bend&#39;s closure, which is more likely
            given they&#39;ve shipped 1 game in 15 years that came with a lot of
            controversy. They&#39;re also years away from shipping a second. At
            the very least, don&#39;t expect a new Bend title until PS6, making
            the PS5 a truly wasted generation for them due to former leadership
            and Sony&#39;s poor live service execution.
          </Paragraph>
        </div>
