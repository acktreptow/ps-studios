...
function MediaMoleculePage() {
  return (
    <div className="bg-white text-gray-700 p-10">
      ...
      <p className="mb-5 text-lg">
        Whatever Media Molecule&#39;s next game is, I wouldn&#39;t expect much
        as they&#39;re far removed from their heyday during the PS3 generation.
      </p>
      <p className="mb-5 text-lg">
        Dreams wasn&#39;t close to a commercial success, the vast majority of
        Media Molecule&#39;s founders have left, and it&#39;s been reported that
        they were extremely close to being shuttered in late 2023, instead of
        London Studio.
      </p>
      <p className="mb-5 text-lg">
      ...
      <p className="mb-5 text-lg">
        For what it&#39;s worth, I hope I&#39;m wrong. Even if they don&#39;t
        sell well, Sony needs the types of games Media Molecule makes to have a
        diverse portfolio.
      </p>
      <Image
        src={sackboy}
