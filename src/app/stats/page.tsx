      ...
      <div className="lg:flex items-center mb-3">
        <div>
          ...
          <StatsList isNumbered={false}>
            ...
            <li>Released PS5 games that are on PC: 29</li>
            <li>Released PS5 games games that originated on PS4: 11</li>
          ...
          <StatsList isNumbered={false}>
            ...
            <li>
              ...
              remakes/remasters): Bluepoint (1 remake averaging to 92) or
              Naughty Dog (3 remasters/remakes averaging to 88.67)
            </li>
            <li>
          ...
          <Paragraph>
            ...
            a result, many games released not only months or years apart in
            different regions (sometimes not at all), but also under different
            names. Here are the legacy games that had multiple names depending
            on the region:
          </Paragraph>
          <StatsList isNumbered={true}>
            ...
            <li>
              Twisted Metal 2 (NA) / Twisted Metal: World Tour (EU) / Twisted
              Metal EX (JP)
            </li>
