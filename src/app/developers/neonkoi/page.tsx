...
function NeonKoiPage() {
  return (
    <div className="bg-white text-gray-700 p-10">
      ...
      <p className="mb-5 text-lg">
        In fact, Neon Koi has primarily been in the news for negative headlines.
        Like when the head of PlayStation&#39;s Mobile Division and a Savage
        founding member abruptly left PlayStation under suspicious
        circumstances, in quick succession.
      </p>
      <p className="mb-5 text-lg">
        These headlines probably contributed to the rebranding to Neon Koi in
        November, 2023. Between that and the revamped website, hopefully it
        means at the least, a game announcement is coming soon. We can then
        start determining if Neon Koi are worth keeping an eye on.
      </p>
      <Image
        src={savageLogo}
