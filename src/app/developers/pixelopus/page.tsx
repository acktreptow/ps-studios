  ...
  return (
    <Container>
      ...
      <Paragraph>
        ...
        under unique circumstances. In 2012, Thatgamecompany released PS3 indie
        adventure Journey to critical and commercial acclaim. This inspired
        Sony&#39;s Foster City Studio (now San Mateo Studio) to fund small
        development teams and emulate this success.
      </Paragraph>
      <Paragraph>
        One university they funded was Carnegie Mellon, which they gave PS Vitas
        to experiment with in 2013. 6 students were hired, along with 3 from San
        Jose State University and 2 industry vets, to form Pixelopus in 2014.
        That same year, they released Entwined for PS3, PS4, and Vita. The
        twin-stick rhythm title shadow-dropped at Sony&#39;s 2014 E3 showcase,
        but only received tepid critical and commercial success.
      </Paragraph>
