    ...
    <Container>
      ...
      <ImageSection flexOnMdScreens={false}>
        <div>
          ...
          <Paragraph>
            Outside of Helldivers 2, Sony&#39;s live-service strategy has
            failed. Most second-party games are cancelled, newly acquired
            studios have delayed games or closed, and old studios like Bend have
            wasted the generation on it. This has caused Sony&#39;s first-party
            output to become sporadic since 2022, resulting in the prestige of
            PS Studios taking a significant hit.
          </Paragraph>
          <Paragraph>
            JS&#39;s AA games don&#39;t sell millions with a 90+ Metacritic, but
            the smaller scope means many would ship on modest budgets, allowing
            Sony to have consistent releases without overspending. With so few
            AAA titles, hardcore fans would also evangelize AA titles more than
            they would have pre-2023. Astro Bot&#39;s success demonstrates this
            perfectly.
          </Paragraph>
          <Paragraph marginBottom={8}>
            ...
            also licensed Everybody&#39;s Golf, Freedom Wars, and Patapon from
            Sony to release sequels and remakes. Between these titles and Asobi,
